...
class VLoginCellPassword:VLoginCell, UITextFieldDelegate
{
    ...
    override init(frame:CGRect)
    {
        ...
        textField.placeholder = NSLocalizedString("VLoginCellPassword_placeholder", comment:"")
    ...
    override func config(controller:CLogin, model:MLoginItem)
    {
        ...
        textField.text = controller.model.password
    }
    ...
    {
        let password:String? = textField.text
