...
class VPhotosAlbumPhotoSettings:UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    convenience init(controller:CPhotosAlbumPhotoSettings)
    {
        ...
        collectionView.register(
            VPhotosAlbumPhotoSettingsCellSize.self,
            forCellWithReuseIdentifier:
            VPhotosAlbumPhotoSettingsCellSize.reusableIdentifier)
        collectionView.register(
        ...
        collectionView.register(
            VPhotosAlbumPhotoSettingsCellAlbum.self,
            forCellWithReuseIdentifier:
            VPhotosAlbumPhotoSettingsCellAlbum.reusableIdentifier)
