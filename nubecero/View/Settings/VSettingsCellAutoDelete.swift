...
class VSettingsCellAutoDelete:VSettingsCell
{
    ...
    override init(frame:CGRect)
    {
        ...
        label.text = NSLocalizedString("VSettingsCellAutoDelete_label", comment:"")
        ...
        labelDescription.text = NSLocalizedString("VSettingsCellAutoDelete_labelDescription", comment:"")
    ...
    {
        let autoDeleteOn:Bool = check.isOn
        MSession.sharedInstance.settings.current?.autoDelete = autoDeleteOn
